...
On the other hand, if you are looking for the previous version of the course (soon to be archived) and called the [Angular Material Course](angular-material-course-v1), then you can start your course with the initial branch [1-navigation-and-containers](https://github.com/angular-university/angular-material-course/tree/1-navigation-and-containers).
